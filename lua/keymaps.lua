...
keymap("v", "<Space>rs", "y:!rg \"<C-R>\"\" . > ~/.config/nvim/rg.log<CR>",opts)
keymap("n", "<Space>rs", ":!rg \"<C-R><C-W>\" . > ~/.config/nvim/rg.log<CR>",opts)
keymap("n", "<Space>rl", ":e ~/.config/nvim/rg.log<CR>",opts)
